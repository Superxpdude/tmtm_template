...
class stage_base
{
	...
	initScript = ""; // String containing code to be compiled then executed when the stage is activated
	endScript = ""; // String containing code to be compiled then executed when the stage is terminated
